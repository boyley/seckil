...
import com.danlu.seckil.user.service.DatabaseUserService;
...
public class AjaxAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    public AjaxAuthenticationProvider(final DatabaseUserService databaseUserService, final BCryptPasswordEncoder encoder) {
        this.userService = databaseUserService;
